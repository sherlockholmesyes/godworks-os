...
| Broad-query failure | Clean | The runtime gate includes an in-radius decoy; a broad query cannot satisfy `qbi_ast_ok`. |
...
This is a boolean AST over the current atom set. Still open:

- richer field/value predicates;
